...
Modified for Properer Bangumi RSS (v0.2)
Fishswing <me@swingworks.net>
...
class RSSCreator091 extends FeedCreator {
	...
	function createFeed() {
		...
		$feed.= $this->_createGeneratorComment();
		$feed.= $this->_createStylesheetReferences();
		$feed.= "<rss version=\"".$this->RSSVersion.'" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:dc="http://purl.org/dc/elements/1.1/">'."\n";
		$feed.= "    <channel>\n";
		...
		for ($i=0;$i<count($this->items);$i++) {
			...
			*/
			...
			else $feed.= "            <guid isPermaLink=\"false\">".htmlspecialchars($this->items[$i]->link)."</guid>\n";
